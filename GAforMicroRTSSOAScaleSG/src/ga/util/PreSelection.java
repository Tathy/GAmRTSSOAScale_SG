...
public class PreSelection {
	...
	public static <K, V extends Comparable<? super V>> Map<K, V> sortByValue(Map<K, V> map, String id) {
		int size_elite = ConfigurationsGA.SIZE_ELITE;
		if(id == "1") size_elite = ConfigurationsGA.SIZE_ELITE;
		else if(id == "2") size_elite = ConfigurationsGA.SIZE_ELITE_2;
		...
		for (Iterator it = list.iterator(); it.hasNext();) {
			...
			if(sortedHashMap.size() == size_elite)
			{
				break;
			}
		} 
